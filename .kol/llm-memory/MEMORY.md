# Memory Index — kol-chess repo tier

> Global tier: `~/.dotfiles/claude/memory/MEMORY.md` — cross-repo facts; read it too.

- [No dev servers for user](no-dev-servers-for-user.md) — never start/restart a dev server even on "run it"; he runs his own and kills Claude-started servers on sight
